...
| legally-mine | Legally Mine, LLC | org | neutral |  | Utah asset-protection firm; Ammon (Pres.) & Matt (VP Mktg) McNeff held roles here 2011–2020 (per BAM FDD); renamed "LM Oldco, LLC" May 21, 2026 | ⚠ The 2025 Ohio Supreme Court UPL finding (Case 2025-0037) names a *different* McNeff — **Daniel** — as its sole member/manager; don't conflate with Ammon/Matt. Renamed "LM Oldco, LLC" by an amendment stamped May 21, 2026 — the day the first video posted; the record states no reason, and causal readings are speculation. |  |
...
| centra-wealth | Centra Wealth Solutions, LLC | org | neutral |  | Utah LLC (formed Apr 6, 2026); owner of the re-registered "Legally Mine" assumed names | Registered the "Legally Mine" + "Legally Mine Tax and Accounting" assumed names (DBAs) on May 29, 2026, after Legally Mine, LLC was renamed LM Oldco, LLC. No McNeff among its registry principals; not a party to the suit. |  |
...
| daniel-mcneff | sole member/manager of | legally-mine | corporate | → | CONFIRMED | Per the Ohio Sup. Ct. UPL order (2025-0037) and the 2021 Utah UCC-1; still the member of record after the entity was renamed LM Oldco, LLC — he signed the May 21, 2026 renaming amendment. |
...
| centra-wealth | now holds the "Legally Mine" trade names | legally-mine | corporate | → | CONFIRMED | Utah assumed names 14701446-0151 & 14701452-0151 (filed May 29, 2026), registered eight days after the entity renamed itself LM Oldco, LLC (amendment stamped May 21, 2026, 4:49 PM; signed by Daniel J. McNeff). Whether this reflects a sale/transfer of the business is not in the public record. |
